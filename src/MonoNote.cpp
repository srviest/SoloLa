...
MonoNote::process(const vector<vector<pair<double, double> > > pitchProb)// pitchProb.first: frame-level pitch sequence in MIDI number scale
                                                                         // pitchProb.second: probability-0.9
{                                                                           
